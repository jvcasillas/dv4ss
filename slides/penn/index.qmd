...
institute: "Penn State Research Methods Workshop"
date: "2024/11/01 (Last update: `r Sys.Date()`)"
...
[slido](https://wall.sli.do/event/ipmt2aXBnzydYcjtAXxr3r?section=85be5578-563d-4c51-9274-ff400b365a07)
...
- Watch
- Come back when time/resources allow
- Use webR demo
:::
::::
...
## {background-image="../assets/img/bad_plots/bad_plot_0.png" background-size="contain" data-menu-title="The ugliest plot in the world"}
...
::: {.r-stack}
![](../assets/img/plot_heatmap_0.png){.absolute top=25 right=100 width="60%"}

<!--
![](../assets/img/plot_heatmap_1.png){.absolute top=150 right=30 width="80%"}

<!--
![](../assets/img/plot_heatmap_2.png){.fragment .absolute top=65 right=35 width="85%"}
-->
:::
...
::: {.r-stack}
![](../assets/img/bad_plots/bad_plot_1){width="750" height="650"}

![](../assets/img/bad_plots/bad_plot_0){.fragment width="900" height="650"}

![](../assets/img/bad_plots/bad_plot_2){.fragment width="1000" height="650"}
:::

## {data-menu-title="More bad plots"}

::: {.r-stack}
![](../assets/img/bad_plots/bad_plot_3){width="750" height="650"}

![](../assets/img/bad_plots/bad_plot_4){.fragment width="900" height="650"}

![](../assets/img/bad_plots/bad_plot_5){.fragment width="1000" height="650"}
:::


## {data-menu-title="Even more bad plots"}

::: {.r-stack}
![](../assets/img/bad_plots/bad_plot_6){width="750" height="650"}

![](../assets/img/bad_plots/bad_plot_7){.fragment width="800" height="650"}

![](../assets/img/bad_plots/bad_plot_8){.fragment width="1000" height="550"}

![](../assets/img/bad_plots/bad_plot_11){.fragment width="1000" height="600"}

![](../assets/img/bad_plots/bad_plot_12){.fragment width="9000" height="700"}

![](../assets/img/bad_plots/bad_plot_13){.fragment width="900" height="700"}

![](../assets/img/bad_plots/bad_plot_14){.fragment width="900" height="700"}
:::
